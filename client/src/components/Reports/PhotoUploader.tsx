...
function PhotoUploader() {
  ...
  return (
    <div className="flex flex-col items-center gap-y-4">
      <div
        className=" w-full sm:w-3/4 lg:w-1/2 min-h-[10rem] md:min-h-[12rem] 2xl:min-h-[14rem] max-h-[20rem] border-4 border-opacity-50 border-[#333] rounded-xl border-dotted flex items-center justify-center overflow-hidden cursor-pointer"
        //@ts-ignore
      ...
      >
        {photo ? (
          ...
          <div className="flex flex-col items-center gap-y-2">
            ...
            <span className="font-semibold md:text-lg">Upload Photo</span>
          </div>
        )}
      ...
      <div className="w-full sm:w-3/4 lg:w-1/2  rounded-full  flex items-center justify-end py-2 px-4 bg-[#222] bg-opacity-10">
