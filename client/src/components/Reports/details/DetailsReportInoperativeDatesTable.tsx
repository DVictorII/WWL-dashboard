...
function DetailsReportInoperativeDatesTable({
  report,
}: {
  ...
  const { inoperativeDates, lastReading } = JSON.parse(
    report.report_readings_information
  );
...
export default DetailsReportInoperativeDatesTable;
