        ...
        <thead>
          ...
          >
            <th className="flex items-center gap-x-2 ">
              <span className="text-[11px] md:text-xs text-start leading-relaxed">Inoperative days</span>
            </th>
          </tr>
        </thead>
              ...
              inoperativeDates.map((obj, i)=>(
                ...
                >
                  <th className="w-full flex items-center gap-x-3">
                    <span className="text-[9px] md:text-[10px]">{obj.inoperativeDays} days:</span>
                    <span className="text-[9px] md:text-[10px]">From {moment(obj.currentDate).format("MMM DD, YYYY [at] HH:mm")}</span>
                    <span className="text-[9px] md:text-[10px]">to {moment(obj.nextDate).format("MMM DD, YYYY [at] HH:mm")}</span>
                  </th>
                </tr>
              ))
            }</>): (
              <tr
                ...
                >
                  <th className="w-full h-full flex items-center justify-center gap-x-2 ">
                    <span className="text-xs">Everything ok! No inoperative days for the current days span.</span>
                  </th>
                </tr>
            )
          }
